...
function App() {
  ...
  return (
    <AppLayout
      ...
      correctionAdditional={correctionAdditional}
      ...
      handleCorrectionMode={handleCorrectionMode}
      ...
      setChatEndDate={setChatEndDate}
      setChatInput={setChatInput}
      setChatModel={setChatModel}
      setChatStartDate={setChatStartDate}
      setCorrectionAdditional={setCorrectionAdditional}
      setCorrectionDate={setCorrectionDate}
      setCorrectionModalOpen={setCorrectionModalOpen}
      ...
      setPrEndDate={setPrEndDate}
      setPrStartDate={setPrStartDate}
