...
const labelClassName =
  'block text-xs text-[#444]'

const inputClassName =
  'mt-0.5 block w-full box-border rounded border border-[#ccc] bg-white p-1'

const checkboxClassName =
  'mb-0 ml-0 mr-1 mt-0 align-middle'

const tableClassName =
  'w-full border-collapse bg-white text-xs'
...
function AttendancePanel(props) {
  ...
  const hasEnterMail = attendanceRows.some(
    (row) => row.isEnterMailEnabled,
  )
                    ...
                    <td className={tdClassName}>
                      <div className="flex flex-wrap gap-1">
                        <button
                          ...
                          className={[
                            rowActionClassName,
                            row.isEnterMailEnabled &&
                              "before:content-['mail_']",
                          ]
                            .filter(Boolean)
                            .join(' ')}
