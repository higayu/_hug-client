(() => {
  ...
  const addFormStyle = () => {
    ...
    style.textContent = `
      ...
      #hug-attendance-panel .hug-name-text {
        min-width: 6em;
        white-space: nowrap;
      }

      #hug-attendance-panel .hug-btn-personal-record {
        padding: 2px 6px;
        font-size: inherit;
        font-weight: inherit;
        cursor: pointer;
      ...
      #hug-attendance-panel .hug-btn-personal-record:hover {
        color: #43a047;
      ...
      #hug-attendance-panel .hug-kasan-copy {
        background: #fffbe6;
        text-align: center;
        white-space: nowrap;
      }

      #hug-attendance-panel .hug-btn-record-move {
        padding: 4px 10px;
        font-size: 12px;
        cursor: pointer;
      ...
      #hug-attendance-panel .hug-btn-record-move:hover {
        background: #e9ecef;
      }
      ...
      /* サイドパネル: タブ領域＝フォーム本体（浮動枠なし） */
      #hug-sidepanel-host #hug-attendance-panel.hug-sidepanel-form-root {
        position: static;
        width: 100%;
        max-width: none;
        border: none;
      ...
      #hug-sidepanel-host #hug-attendance-panel.hug-sidepanel-form-root .hug-attendance-body {
        max-height: none;
      }
